# This is my package filament-alert-component
...
```css
@source '../../../../vendor/gosuperscript/filament-alert-component/resources/**/*.blade.php';
```

You can publish and run the migrations with:

```bash
php artisan vendor:publish --tag="filament-alert-component-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="filament-alert-component-config"
```

Optionally, you can publish the views using

```bash
php artisan vendor:publish --tag="filament-alert-component-views"
```
...
```php
$filamentAlertComponent = new Superscript\FilamentAlertComponent();
echo $filamentAlertComponent->echoPhrase('Hello, Superscript!');
```
